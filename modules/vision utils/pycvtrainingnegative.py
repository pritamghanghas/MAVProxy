...
Running this code will produce a Putty encoded dataset of 'negative' feature vectors.
(negative meaning that the target you are trying to track is absent)
'''
...
''' export data '''
data_file = open('training_negative.txt', 'w+')
